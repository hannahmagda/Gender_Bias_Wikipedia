...
---
Skript to create figures and tables to present the results of the Pointwise Mutual Information analysis. The results can be visualized as bar plots or as tables, the ladder is more useful for the bigger subgroups of interest like Party comparisons.
...
the PMI lists were created in the previous script and annotated in excel. Now we can load these annotaded lists to observe the share of categories (Family, Gender, Relatioonship and Other) for all subgroups of interest
