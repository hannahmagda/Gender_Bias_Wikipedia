...
---
Skript to create plots and tables to present the results of the Pointwise Mutual Information. The results can be visualized as bar plots or as tables, which is more useful for the bigger Subgroups of interest like Party comparisons.
...
pmi_plot <- function(df_female, df_male) {
  ...
  # create a label for the P-Value
...
sensitivity analysis career section
```{r}
...
sensitivity analysis life section
```{r}
...
options(width = 10, height = 8, dpi = 600)
