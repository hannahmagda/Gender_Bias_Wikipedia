...
#main analysis uses threshhold min_p as 0.0002 - senstivity is shown with value 0.001 as used by Wagner et al.
calculate_pmi_and_filter <- function(corpus_transposed, corpus_name, min_p = 0.0003) {
...
######## IMOPRTANT: Set min_p to the respective threshhold you want to test! #########################################
