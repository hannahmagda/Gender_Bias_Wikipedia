...
---
Skript to output the word lists ranked by pmi values per gender
...
necessary functions for the pmi analysis
```{r}

prepare_corpus <- function(data_frame, text_column) {
  # apply to a copied df in order to leave the original df untouched
  df_copy <- data_frame
...
#all words that I do not want to include in the analysis need to be removed in the next step
