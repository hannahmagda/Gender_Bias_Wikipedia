...
This script provides the code to aquire the necessary Wikipedia Data for my analyis, using the CLD database and the wikiediaR package. It outputs the raw data used for the analysis, that is "deu_text".
