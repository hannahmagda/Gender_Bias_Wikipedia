...
#first, the data is prepared to be in the necessary shpe for the PMI analyis by the following function
...
# define words that mess with the analyis, starting with gender senstitive occupation labels
...
#extract stopwords "Stoppwörter der Deutschen Rechtssprache (SW-DE-RS)" (Fobbe, 2020)
...
process_corpus <- function(corpus, gender_neutral_replacements, words_to_remove) {
  ...
  # Tokenizing the corpus and removing/replacing data that messes with the analyis
  # puntuation, capital letters, numbers etc. are removed
...
# apply the function to the coumn birthyear
...
# create one dataframe per cohort to conduct the PMI analyis for each cohort
